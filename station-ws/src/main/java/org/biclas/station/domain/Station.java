package org.biclas.station.domain;
...
public class Station {
	...
	/**
	 * Global counter of biclas Gets. Uses lock-free thread-safe single variable.
    ...
    /** Global counter of biclas Returns. Uses lock-free thread-safe single variable. */
	...
	public synchronized void reset() {
 	...
 	/** Synchronized locks object before attempting to return Bicla */
	public synchronized int returnBicla() throws NoSlotAvailException {
		if(getFreeDocks() == 0)
	...
	/** Synchronized locks object before attempting to get Bicla */
	public synchronized void getBicla() throws NoBiclaAvailException {
		if(getFreeDocks() == getMaxCapacity())
			throw new NoBiclaAvailException();
    ...
    /** Synchronized locks object before returning available biclas */
    public synchronized int getAvailablebiclas() {
